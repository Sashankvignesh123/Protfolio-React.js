  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/sashankvignesh.p?mibextid=ZbWKwL"
            ...
            <li>
              <a
                href="https://www.instagram.com/sashankvignesh/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://x.com/sashank1834256?t=cWkiKxcVOFDtZs3SL0Ejug&s=09"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/posina-sashank-vignesh-8b5839240/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by Sashank Vignesh Posina</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
